    ...
    class SabreAMF_AMF0_Deserializer extends SabreAMF_Deserializer {
        ...
        public function readAMFData($settype = null,$newscope = false) {
           ...
           switch ($settype) {
                ...
                case 0x00 : return $this->stream->readDouble();
                case 0x01 : return $this->stream->readByte()==true;
                case 0x02 : return $this->readString();
                case 0x03 : return $this->readObject();

                case 0x05 : return null; 
                case 0x06 : return null;
                case 0x07  : return $this->readReference();
                case 0x08  : return $this->readMixedArray();
                case 0x0a : return $this->readArray();
                case 0x0b : return $this->readDate();
                case 0x0c : return $this->readLongString();
                case 0x0e : return null;

                case 0x0f : return $this->readLongString();
                case 0x10 : return $this->readTypedObject();
                case 0x11 : return $this->readAMF3Data();
